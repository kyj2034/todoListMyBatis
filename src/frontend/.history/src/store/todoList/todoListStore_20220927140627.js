...
const actions = {
  ...
  setChkIdxAct: (state, payload) => { state.chkIdx = payload; },
  setChkUpdIdxAct: ({ commit }, payload) => { state.chkUpdIdx = payload;  console.debug(state.chkUpdIdx);  },
  setChkDelIdxAct: ({ commit }, payload) => { state.chkDelIdx = payload; },
...
const mutations = {
  ...
  setChkUpdIdx: (state, payload) => { console.debug(payload); state.chkUpdIdx = payload; },
  setChkDelIdx: (state, payload) => { console.debug(payload); state.chkDelIdx = payload; },
