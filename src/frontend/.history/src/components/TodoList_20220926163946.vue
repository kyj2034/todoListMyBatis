...
const todoItemStorePrefix = '/todoItemStore';
...
export default {
  ...
  computed: {
    ...
    ...mapGetters({
      getTodoList: `${todoItemStorePrefix}/getTodoList `,
      getChkUpdIdx: `${editModeStorePrefix}/getChkUpdIdx`,
      getChkDelIdx: `${editModeStorePrefix}/getChkDelIdx`,
  ...
  methods: {
    ...
    ...mapActions(todoItemStorePrefix,
    [
      'finishTodoAct',
      'loadTodoAct',
      'setTodoListAct',
    ...
    finTodo({ key, todo, finish, idx}) {
      const finItem = { key, todo, finish: !finish, idx};
