<template>
  <div class="inputBox shadow" v-show="showAddForm">
    <input
      type="text"
      v-model= "newTodoVal"
    ...
    <modal v-if="showModal" @close="setShowModalAct(false)">
...
export default {
  ...
  computed: { // showModal : 모달 on/off Boolean
    ...mapGetters({
      showModal: `${editModeStorePrefix}/getShowModal`,
      showAddForm: `${editModeStorePrefix}/getShowAddForm`,
    }),
  },
  methods: {
